...
\begin{frame}
	...
	\begin{itemize}
		...
		$\quad \rightarrow$ Make the function to be more stable to use with categorical variables
...
\begin{itemize}
	\item Model selection: Model with lower BIC value is preferable
...
\begin{itemize}
	...
	\item E-divisive method can detect fewer change point locations and failed to detect many changes
