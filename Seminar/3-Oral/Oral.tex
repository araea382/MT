...
\begin{itemize}
	...
	%\item  If the response variable value fluctuates but the average value does not change drastically, the E-divisive method will not be able to identify the state change.
\end{itemize}
