...
\title{Applying Machine Learning to LTE/5G Performance Trend Analysis}

\author{Araya Eamrurksiri}

\publishers{\includegraphics{\string"LinkUniv sigill blk\string".eps}\vspace{\baselineskip}\\
...
\\
\emph{LiU:} Dr. Krzysztof Bartoszek\\
\\
\emph{Ericsson: }Armin Catovic and Jonas Eriksson\bigskip{}
\\
