...
\begin{comment}
A hidden Markov model\textquoteright s states represent some unobservable
condition of the sys- tem being modeled. In each state, there is a
certain probability of producing any of the observable system outputs
and a separate probability indicating the likely next states. By having
different output probability distributions in each of the states,
